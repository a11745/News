    ...
    <div class="col-md-9">
        <div class="panel panel-warning">
            <div class="panel-heading">
                <h3 class="panel-title"><span class="glyphicon glyphicon-map-marker"></span>&nbsp;我的收藏</h3>
            </div>
            <div class="panel-body">
                ...
                <c:forEach items="${pageInfo.list}"   var="comm">
                    <div class="media">
                        <div class="media-left" >
                            <a href="/details?itemId=${comm.detailId}" >
                                <img width="200px" height="70px" class="media-object" src="${comm.image1 }" alt="${comm.title }">
                            </a>
                        </div>
                        <div class="media-body">
                            <h4 class="media-heading"><!-- 环太平洋 --><a href="/details?itemId=${comm.detailId}" class="label label-primary pull-right"><span class="glyphicon glyphicon-play"></span>查看新闻</a></h4>
                            ${comm.title }
                        </div>
                    </div>
                    </c:forEach>
                ...
                <div class="col-md-12 text-center">
                        <nav aria-label="Page navigation">
                            <ul class="pagination">
                                <li>
                                    <a href="/moviecol?pn=1" aria-label="First">
                                ...
                                <li >
                                    <a href="/moviecol?pn=${pageInfo.pageNum-1}" aria-label="Previous">
			                    ...
			                    <c:forEach items="${pageInfo.navigatepageNums}" var="page_num">  
			                        ...
			                        <c:if test="${page_num != pageInfo.pageNum}">  
			                            <li><a href="/moviecol?pn=${page_num}">${page_num}</a></li>  
			                        </c:if>  
			                    </c:forEach>
			                    <c:if test="${pageInfo.hasNextPage}">
                                <li>
                                    <a href="/moviecol?pn=${pageInfo.pageNum+1}" aria-label="Next">
                                ...
                                <li>
                                    <a href="/moviecol?pn=${pageInfo.pages}" aria-label="Last">
