                ...
                <form role="form">
                    <fieldset>
                            <div class="form-group">
                                ...
                                <input id="input_name" class="form-control" placeholder="昵称" name="name" type="text" autofocus value="${user.userName }">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input id="uploadImage1" id="input_face" class="form-control" name="face" type="hidden" autofocus>
                            </div>
                            <div class="col-md-12" id="error_face"></div>
                            <div class="form-group">
                                <label for="input_info"><span class="glyphicon glyphicon-edit"></span>&nbsp;简介</label>
                                <textarea class="form-control" rows="10" id="input_info">${user.info }</textarea>
                            </div>
